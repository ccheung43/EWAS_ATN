...
E4_status = c(1,0)
for(subgroup in unique(E4_status)) { 
  subgroup_condition = expr(E4 == !!subgroup)
  ...
  lapply(names(res[[1]]), function(biomarker) { 
    ...
    path = "Results/E4_stratified/"
    file_name = paste0(path, biomarker, "/", biomarker, "_EWAS_E4", subgroup, "_", blk, ".csv")
