...
correct_bacon <- function(biomarker, subgroup) {
  ...
  input_file <- paste0("2024_EWAS_ATN/ATN_EWAS/Results/MCI_stratified/", biomarker, "_", subgroup, "_EWAS_Results_Full.csv")
  output_file <- paste0("2024_EWAS_ATN/ATN_EWAS/Results/MCI_stratified/", biomarker, "_", subgroup, "_EWAS_Results_Corrected.csv")
