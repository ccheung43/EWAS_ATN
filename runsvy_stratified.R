# Function to run survey-weighted GLM on CpG methylation data, for a stratified dataset

runsvy_stratified <- function(cpg_list, ppath, mpath, biomarkers, subgroup_condition) {
