...
process_qq <- function(biomarker, subgroup) {
  ...
  input_file <- paste0("2024_EWAS_ATN/ATN_EWAS/Results/MCI_stratified/", biomarker, "_", subgroup, "_EWAS_Results_Corrected.csv")
  ...
  biomarker_title <- switch(biomarker,
                            ...
                            "NFLIGHT" = "NfL", 
                            "GFAP" = "GFAP")
  MCI_title <- switch(subgroup, 
                      "MCI1" = "MCI", 
                      "MCI0" = "Control")
  title = paste0(biomarker_title, " - ", MCI_title)
  ...
  # Save Manhattan plot
  output_path <- paste0("2024_EWAS_ATN/ATN_EWAS/Results/MCI_stratified", biomarker, "_", subgroup, "_ManhattanPlot.jpg")
  
  thresh_lty <- if (is.null(threshold_5)) 2 else c(1, 2)
  
  setwd("C:/Users/caitl/OneDrive - Beth Israel Lahey Health/2024_EWAS_ATN/ATN_EWAS/Results/MCI_stratified")
